...
- **Autonomous Driving & Robotics:** ROS/ROS2, Autoware, LiDAR sensor drivers, GNSS-based time synchronization, multi-sensor data acquisition
- **LiDAR Perception & 3D Vision:** 3D point clouds, full-waveform LiDAR, object detection, multi-object tracking, sensor calibration, dataset construction
- **Security & Experimental Systems:** LiDAR spoofing, sensor security evaluation, experimental system design, real-world data collection and analysis
- **Programming & ML:** C++, Python, PyTorch, TypeScript, JavaScript
